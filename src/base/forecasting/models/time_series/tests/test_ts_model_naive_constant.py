...
from src.base.forecasting.models.ts_model_naive_constant import TimeSeriesModelNaiveConstant
...
def test_ts_model_naive_constant():
    ...
    expected_forecast = np.array([4, 4, 4])

    # --- act ---------------------------------------------
    model = TimeSeriesModelNaiveConstant("signal_a")
